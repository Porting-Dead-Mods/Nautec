...
public class MobAugmentEntry extends BaseNautecEntry {
    public MobAugmentEntry(CategoryProviderBase parent) {
        super(parent, "mob_augments", "Mob Augments", "Yep, you need to kill ALL of those", BookIconModel.create(NTItems.DOLPHIN_FIN));
    }
