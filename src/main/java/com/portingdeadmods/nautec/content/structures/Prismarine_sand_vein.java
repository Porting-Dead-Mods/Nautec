...
public class Prismarine_sand_vein extends Structure {
    public static final MapCodec<Prismarine_sand_vein> CODEC = RecordCodecBuilder.mapCodec(instance ->
            instance.group(Prismarine_sand_vein.settingsCodec(instance),
            ...
            ).apply(instance, Prismarine_sand_vein::new));
    ...
    public Prismarine_sand_vein(StructureSettings config,
    ...
    private static boolean extraSpawningChecks(GenerationContext context) {
        ...
        // Grabs the block position we are at
        BlockPos pos = new BlockPos(chunkpos.getMinBlockX(), context.chunkGenerator().getSeaLevel(), chunkpos.getMinBlockZ());

        // Checks to make sure our structure does not spawn above land that's higher than y = 150
        // to demonstrate how this method is good for checking extra conditions for spawning
        boolean res1 = (context.chunkGenerator().getFirstOccupiedHeight(
    ...
    public Optional<GenerationStub> findGenerationPoint(GenerationContext context) {
        ...
        if (!Prismarine_sand_vein.extraSpawningChecks(context)) {
