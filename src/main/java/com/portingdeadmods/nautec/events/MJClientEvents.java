...
public final class MJClientEvents {
    ...
    public static final class ClientBus {
        ...
        public static void onFMLClientSetupEvent(final FMLClientSetupEvent event) {
            event.enqueueWork(() -> {
                ItemProperties.register(MJItems.AQUARINE_SWORD.get(), ResourceLocation.fromNamespaceAndPath(Nautec.MODID, "enabled"),
                        (stack, level, living, id) -> MJDataComponentsUtils.isAbilityEnabledNBT(stack));
                ItemProperties.register(MJItems.AQUARINE_PICKAXE.get(), ResourceLocation.fromNamespaceAndPath(Nautec.MODID, "enabled"),
                        (stack, level, living, id) -> MJDataComponentsUtils.isAbilityEnabledNBT(stack));
                ItemProperties.register(MJItems.AQUARINE_AXE.get(), ResourceLocation.fromNamespaceAndPath(Nautec.MODID, "enabled"),
                        (stack, level, living, id) -> MJDataComponentsUtils.isAbilityEnabledNBT(stack));
                ItemProperties.register(MJItems.AQUARINE_SHOVEL.get(), ResourceLocation.fromNamespaceAndPath(Nautec.MODID, "enabled"),
                        (stack, level, living, id) -> MJDataComponentsUtils.isAbilityEnabledNBT(stack));
                ItemProperties.register(MJItems.AQUARINE_HOE.get(), ResourceLocation.fromNamespaceAndPath(Nautec.MODID, "enabled"),
                        (stack, level, living, id) -> MJDataComponentsUtils.isAbilityEnabledNBT(stack));
            });
        }
    }
