...
import com.portingdeadmods.modjam.content.structures.Crystal_geode;
...
public class MJStructures {
    ...
    public static DeferredHolder<StructureType<?>, StructureType<Crystal_geode>> CRYSTAL_GEODE = STRUCTURES.register("crystal_geode", () -> explicitStructureTypeTyping(Crystal_geode.CODEC));
