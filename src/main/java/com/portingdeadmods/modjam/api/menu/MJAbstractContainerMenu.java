package com.portingdeadmods.modjam.api.menu;
...
public abstract class MJAbstractContainerMenu<T extends ContainerBlockEntity> extends AbstractContainerMenu {
    ...
    public MJAbstractContainerMenu(MenuType<?> menuType, int containerId, @NotNull Inventory inv, @NotNull T blockEntity) {
