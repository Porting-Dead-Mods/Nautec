...
import com.portingdeadmods.modjam.api.client.model.augments.AugmentModel;
import com.portingdeadmods.modjam.content.augments.DolphinFinAugment;
...
public class DolphinFinModel extends AugmentModel<DolphinFinAugment> {
    public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(ResourceLocation.fromNamespaceAndPath(ModJam.MODID, "dolphin_fin"), "main");
    public static final Material MATERIAL = new Material(
            InventoryMenu.BLOCK_ATLAS, ResourceLocation.fromNamespaceAndPath(ModJam.MODID, "augments/dolphin_fin")
    );
