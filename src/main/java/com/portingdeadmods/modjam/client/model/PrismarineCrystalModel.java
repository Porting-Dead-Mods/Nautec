...
public class PrismarineCrystalModel extends Model {
    public static final Material PRISMARINE_CRYSTAL_LOCATION = new Material(
            InventoryMenu.BLOCK_ATLAS, ResourceLocation.fromNamespaceAndPath(ModJam.MODID, "entity/prismarine_crystal")
    );
    public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(ResourceLocation.fromNamespaceAndPath(ModJam.MODID, "prismarine_crystal"), "main");
