...
public class WhiskModel extends Model {
    public static final Material WHISK_LOCATION = new Material(
            InventoryMenu.BLOCK_ATLAS, ResourceLocation.fromNamespaceAndPath(ModJam.MODID, "entity/whisk")
    );
    public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(ResourceLocation.fromNamespaceAndPath(ModJam.MODID, "custommodel"), "main");
